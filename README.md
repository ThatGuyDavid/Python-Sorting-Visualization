...
Developed a Python Sorting Vizualization App. This app displays the preocess in which 3 sorting algorithms take in sorting data those being, Bubble, INsertion, and Merge. With pygame to implement an interactable UI allowing for ease of use.
